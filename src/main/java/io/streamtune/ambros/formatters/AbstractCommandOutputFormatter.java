...
public abstract class AbstractCommandOutputFormatter {
    private List<Command> commandList;

    public AbstractCommandOutputFormatter(List<Command> cmds) {
        this.commandList = cmds;
    }

    public abstract List<String[]> defineHeaderAndContent(List<Command> commandList);
    ...
    public void print() {
         ...
         */
        List<String[]> tableList = this.defineHeaderAndContent(this.commandList);
